...
namespace MathQuiz
{
    public partial class Form1 : Form
    {
        ...
        // Get the original color of the countdown box
        Color timeLabelColor;

        // Sound for guessing correctly
        ...
        public Form1()
        {
            ...
            successSound = new SoundPlayer(@"c:\Windows\Media\tada.wav");
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            else if (timeLeft > 0)
            {
                ...
                // Time Left label. If there are five seconds or 
                // less time remaining, change the background 
                // color to red.
                timeLeft--;
                if (timeLeft <= 5)
        ...
        private void dateTimer_Click(object sender, EventArgs e)
        {
